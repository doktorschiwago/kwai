...
assert(llvmFib(20) == 6765)
timeit("llvmFib", llvmFib, 20)
...
llvmPisum=byte2llvm(pisum)

assert(abs(pisum()-1.644834071848065) < 1e-12);
timeit("pi_sum", pisum, times=1)

assert(abs(llvmPisum()-1.644834071848065) < 1e-12);
timeit("llvmPisum", llvmPisum, times=1)
